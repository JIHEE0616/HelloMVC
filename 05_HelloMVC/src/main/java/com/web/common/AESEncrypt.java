...
//양방향 암호화메소드를 제공하는 클래스
//java에서 제공함 -> java.crypto, java.security패키지에서 제공하는 클래스를 이용함
//양방향 암호화는 key관리를 잘해야함
...
public class AESEncrypt {
	...
	public AESEncrypt() {
		...
		//2. 생성된 키가 없으면 (key클래스를 저장한 파일이 없으면)그 키를 생성 후 파일로 저장
